...
# PPO training script for openPangu-Embedded-7B with Megatron backend
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name='verl_ppo_openpangu_megatron' \
    trainer.experiment_name='openpangu_7b_ppo_megatron' \
...
echo "PPO training with Megatron backend completed for openPangu-Embedded-7B"