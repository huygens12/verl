...
# GRPO training script for openPangu-Embedded-7B optimized for NPU (Ascend) hardware
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name='verl_grpo_openpangu_npu' \
    trainer.experiment_name='openpangu_7b_grpo_npu' \
...
echo "GRPO training with NPU backend completed for openPangu-Embedded-7B"